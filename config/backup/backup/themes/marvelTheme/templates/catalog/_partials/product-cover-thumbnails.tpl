 ...
 *}
 ...
 <div>
  {block name='product_cover'}
    <div id="open-gallery-btn" class="product-cover image-container ">
  ...
  {block name='product_images'}
    <div class="js-qv-mask mask">
      <ul class="product-images js-qv-product-images" id="my-gallery">
        {foreach from=$product.images item=image}
          <a style="display: none;"
            href="{$image.bySize.large_default.url}" 
            data-pswp-width="{$product.default_image.bySize.small_default.width}" 
            data-pswp-height="{$product.default_image.bySize.small_default.height}">
          </a>
          <li class="thumb-container js-thumb-container">
            <div class="thumb-wraper w {if $image.id_image == $product.default_image.id_image} selected js-thumb-selected {/if}">
              <img
