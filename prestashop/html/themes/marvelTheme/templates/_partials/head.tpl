 ...
 *}
 ...
 <script type="module">
  import PhotoSwipeLightbox from '/themes/child_classic/assets/js/photoswipe-lightbox.esm.min.js';
  import PhotoSwipe from '/themes/child_classic/assets/js/photoswipe.esm.min.js';
  
  
  var openElement = document.getElementById('open-gallery-btn');  
  ...
  <link rel="stylesheet" href="/themes/child_classic/assets/css/photoswipe.css">
